  ...
  generateTensors(preProcessedInputs) {
    if (this.modelSettings.generateTensorsFunc) {
      ...
      return [
        ...
        new Tensor("str" /* String */, [preProcessedInputs.source_lang || "en"], {
          shape: [1, 1],
          name: "source_lang"
        }),
  ...
  generateTensors(preProcessedInputs) {
    if (this.modelSettings.generateTensorsFunc) {
      ...
      let tokens = [
        ...
        new Tensor("int32" /* Int32 */, [preProcessedInputs.num_steps || this.schema.input.properties.num_steps.default], {
          shape: [1],
          name: "num_steps"
        })
      ];
    ...
    if (this.modelSettings.generateTensorsFunc) {
      ...
      if (preProcessedInputs.image && preProcessedInputs.mask) {
        return [
          ...
          new Tensor("int32" /* Int32 */, [preProcessedInputs.num_steps || 20], {
            shape: [1],
            name: "num_steps"
          }),
          new Tensor("float32" /* Float32 */, [preProcessedInputs.strength || 1], {
            shape: [1],
            name: "strength"
          }),
          new Tensor("float32" /* Float32 */, [preProcessedInputs.guidance || 7.5], {
            shape: [1],
            name: "guidance"
          }),
          new Tensor("uint8" /* Uint8 */, preProcessedInputs.image, {
...
var AiSummarization = class {
  ...
  generateTensors(preProcessedInputs) {
    if (this.modelSettings.generateTensorsFunc) {
      ...
      return [
        new Tensor("int32" /* Int32 */, [preProcessedInputs.max_length || this.schema.input.properties.max_length.default], {
          // sequence length
          shape: [1],
          name: "max_length"
        }),
...
var vLLMGenerateTensors = (preProcessedInputs) => {
  const tensors = [
    ...
    new Tensor("str" /* String */, [`{"max_tokens": ${preProcessedInputs.max_tokens}}`], {
      // sequence length
      shape: [1],
